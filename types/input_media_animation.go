...
type InputMediaAnimation struct {
	...
	Width                 int32            `json:"width,omitempty"`                    // Optional. Animation width
	Height                int32            `json:"height,omitempty"`                   // Optional. Animation height
	Duration              int32            `json:"duration,omitempty"`                 // Optional. Animation duration in seconds
